...
// Округляем до цента перед показом: `price * quantity` и сумма по всем
// строкам — обычная float-арифметика, а 0.1 + 0.2 === 0.30000000000000004
// в JS. Сейчас все цены в моках целые, поэтому не проявляется, но реальные
// цены WooCommerce почти всегда с копейками — тогда "€" без округления
// показал бы дребезг вроде €40.699999999999996. .replace убирает лишние
// ".00" у целых сумм, чтобы вид не разошёлся с текущим "€135"
